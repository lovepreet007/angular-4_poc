...
var SecurityService = (function () {
    function SecurityService(_http, _configuration, _router) {
        ...
        this.getUserData = function () {
            _this.setHeaders();
            return _this._http.get('http://localhost:55056/connect/userinfo', {
    ...
    SecurityService.prototype.Authorize = function () {
        ...
        var authorizationUrl = 'http://localhost:55056/connect/authorize';
    ...
    SecurityService.prototype.Logoff = function () {
        ...
        console.log('BEGIN Authorize, no auth data');
        var authorizationUrl = 'http://localhost:55056/connect/endsession';
        var id_token_hint = this.retrieve('authorizationDataIdToken');
        var post_logout_redirect_uri = 'http://localhost:3000/Unauthorized';
        var url = authorizationUrl + '?' +
