...
var FormPoster = (function () {
    ...
    FormPoster.prototype.extractTempData = function (res) {
        var body = res.json();
        return body || null;
    };
    FormPoster.prototype.handleError = function (err) {
