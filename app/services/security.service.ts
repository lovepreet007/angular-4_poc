...
export class SecurityService {
    ...
    public Authorize() {
        ...
        let authorizationUrl = 'http://localhost:55056/connect/authorize';
    ...
    public Logoff() {
        ...
        let authorizationUrl = 'http://localhost:55056/connect/endsession';

        let id_token_hint = this.retrieve('authorizationDataIdToken');
        let post_logout_redirect_uri = 'http://localhost:3000/Unauthorized';
    ...
    private getUserData = (): Observable<string[]> => {
        this.setHeaders();
        return this._http.get('http://localhost:55056/connect/userinfo', {
